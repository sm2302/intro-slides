...
- Install the latest version of R (4.2.0 as of 2022-04-22)
...
- If you are using campus computers, then ensure that you are logged in with your user ID and password. Dedicate a folder where you will store all your work files, which should persist from PC to PC with your login credentials.
